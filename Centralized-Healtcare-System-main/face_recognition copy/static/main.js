    ...
    $('#createChatRoom').click(function(e){
        ...
        // }).done(function(chatRoomDb){ // this request will be executed after server responds with valid data
            $('#chatRoomLink').html(`
                ...
                <code style="padding:10px; font-size:1.2em">http://127.0.0.1:3000/meet/a</code>   
                <a style="margin-left:10px;" class="btn btn-info" id="visitChatRoom" href="http://127.0.0.1:3000/meet/a" target="_blank">Visit</a>
            `);
        // });
